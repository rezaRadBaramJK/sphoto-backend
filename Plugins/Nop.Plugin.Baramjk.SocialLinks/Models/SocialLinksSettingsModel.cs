namespace Nop.Plugin.Baramjk.SocialLinks.Models
{
    public class SocialLinksSettingsModel
    {
        public string WidgetIconSize { get; set; }
        public string SocialMediaIconSize { get; set; }
        public string PaymentMethodIconSize { get; set; }
        public string ProductDetailsIconSize { get; set; }
