...
namespace Nop.Plugin.Baramjk.FrontendApi.Framework.Infrastructure.Mapper.Extensions
{
    public static class MappingExtensions
    {
        ...
        /// <summary>
        ///     Execute a mapping from the source object to a new destination object. The source type is inferred from the source
        ///     object
        /// </summary>
        ...
        public static TBaseJsonDto ToFrameworkDto<TBaseJsonDto>(this object entity)
            where TBaseJsonDto : Baramjk.Framework.Dto.Abstractions.BaseDto
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
