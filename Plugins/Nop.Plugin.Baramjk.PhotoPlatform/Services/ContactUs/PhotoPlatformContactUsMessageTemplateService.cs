...
{
    public class PhotoPlatformContactUsMessageTemplateService
    {
        private const string MessageTemplateName = "PhotoPlatform.ContactUs.ContactOwnerPaymentSuccessful";
        
        private readonly IMessageTemplateService _messageTemplateService;

        public PhotoPlatformContactUsMessageTemplateService(IMessageTemplateService messageTemplateService)
        {
