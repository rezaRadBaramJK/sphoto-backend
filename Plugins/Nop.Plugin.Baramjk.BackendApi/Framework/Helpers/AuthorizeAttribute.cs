...
namespace Nop.Plugin.Baramjk.BackendApi.Framework.Helpers
{
    ...
    public class AuthorizeAttribute : TypeFilterAttribute
    {
        ...
        private class AuthorizeCustomerFilter : IAsyncAuthorizationFilter
        {
            ...
            public AuthorizeCustomerFilter(bool ignoreFilter,
                WebApiBackendSettings webApiCommonSettings)
            {
            ...
            private readonly WebApiBackendSettings _webApiCommonSettings;
