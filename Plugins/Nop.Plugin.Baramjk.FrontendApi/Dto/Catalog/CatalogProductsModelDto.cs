...
namespace Nop.Plugin.Baramjk.FrontendApi.Dto.Catalog
{
    ...
    /// </summary>
    public class CatalogProductsModelDto : BasePageableModelDto
    {
        /// <summary>
        ///     Get or set a value indicating whether use standart or AJAX products loading (applicable to 'paging', 'filtering',
        ///     'view modes') in catalog
        /// </summary>
