...
{
    public class ContactUsNotifyService
    {
        ...
        public ContactUsNotifyService(
            IEmailSender emailSender,
            EmailAccountSettings emailAccountSettings,
            IEmailAccountService emailAccountService,
            ContactUsMessageTemplateService contactUsMessageTemplateService,
        ...
        public async Task SendContactOwnerPaymentSuccessfulEmailAsync(ContactInfoEntity contactInfo)
        {
            ...
            var messageTemplate = await _contactUsMessageTemplateService.GetContactOwnerPaymentSuccessfulMessageTemplateAsync();
            ...
            {
                await _logger.ErrorAsync($"ContactUs: Contact owner payment successful error - Invalid email for contact info with id {contactInfo.Id}.");
                return;
            }
        ...
        private async Task<string> GenerateContactInfoString(ContactInfoEntity contactInfo)
        {
            ...
            var subject = await _subjectService.GetByIdAsync(contactInfo.SubjectId);
